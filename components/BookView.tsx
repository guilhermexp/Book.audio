  ...
  return (
    <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-x-12 lg:gap-x-20">
      ...
      <div className="col-span-1">
        <p className="text-8xl font-serif text-neutral-600 mb-2 -ml-1 select-none">
          {currentPage}
        </p>
        <h1 className="text-5xl font-serif font-medium text-neutral-100 break-words">
          {title}
        </h1>
      </div>
      ...
      <div className="col-span-1 mt-8 md:mt-0 flex flex-col">
        <div className="flex-grow overflow-y-auto max-h-[65vh] pr-4 space-y-8">
          ...
          {isMarkdown ? (
            ...
            <p
              className="leading-9 text-neutral-300"
          ...
          {summary && !isSummarizing && (
            <div className="mt-8 p-5 bg-neutral-800/50 rounded-lg border border-neutral-700">
              ...
              <p
                className="text-neutral-300 font-sans text-base leading-7"
                style={{ whiteSpace: "pre-wrap" }}
              >
                {summary}
              </p>
